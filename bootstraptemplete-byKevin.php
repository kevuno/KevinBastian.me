...
<div class="container">
	...
	<!-- jumbotron will put everything behind a colored box -->
		<div class="jumbotron">
		<p>BUTTONS</p>
		<a href="http://www.facebook.com" class="btn btn-default btn-lg" role="button"> Check this link </a>
		<button type="submit" class="btn btn-danger" > Another button </button>
		...
		<button type="button" class="btn btn-primary btn-lg" disabled="disabled"> WAT </button>
...
<a href="#shownum-content" class="btn btn-default btn-lg" data-toggle="collapse">
 
  <!-- aria-hidden hides decorative icons from screen readers -->
  <span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span> Show me your num bitch
</a>
<div id="shownum_container">

  <div id="shownum-content" class="collapse">
    Whare are those
    222221283
  </div>
</div>
...
<img src="icon.png" id="nttLogo" class="img-responsive img-thumbnail pull-left" alt="Responsive image">
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="pull-left" href="#"><img src="face.jpg"></a>
    </div>
...
<div class="container">
<div class="progress">
  <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 10%;">
